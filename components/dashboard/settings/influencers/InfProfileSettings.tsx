      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            id="event-name"
            placeholder="Name"
            className="bg-[#27292D] rounded-xl p-3 text-white  w-[40%]"
          />
        </div>
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            rows={4}
            className="bg-[#27292D] rounded-xl p-3 text-white resize-none w-[40%]"
          />
        </div>
        <div className="flex flex-col gap-2">
          <label className="text-2xl text-white font-semibold">Website Link</label>
          <input
            type="text"
            id="event-name"
            placeholder="Link"
        ...
        <div className="flex flex-col gap-2">
          <p className="text-2xl text-white font-semibold">Brand Logo</p>
          <Image
            src="/LogoUpload.svg"
            width="252"
            height="300"
